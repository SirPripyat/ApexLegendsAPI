...
exports.LegendService = void 0;
var legends_schema_1 = __importDefault(require("./legends.schema"));
var LegendService = /** @class */ (function () {
    function LegendService() {
    }
    LegendService.prototype.list = function () {
        return __awaiter(this, void 0, void 0, function () {
            var listedLegends;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, legends_schema_1.default.find()];
                    case 1:
                        listedLegends = _a.sent();
                        return [2 /*return*/, listedLegends];
                }
            });
        });
    };
    LegendService.prototype.findName = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            var findedLegend;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, legends_schema_1.default.find({ name: name })];
                    case 1:
                        findedLegend = _a.sent();
                        return [2 /*return*/, findedLegend];
                }
            });
        });
    };
    LegendService.prototype.update = function (id, dataToUpdate) {
        return __awaiter(this, void 0, void 0, function () {
            var updatedLegend;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, legends_schema_1.default.findOneAndUpdate({ _id: id }, {
                    ...
                    case 1:
                        updatedLegend = _a.sent();
                        return [2 /*return*/, updatedLegend];
                }
            });
        });
    };
...
//# sourceMappingURL=legends.service.js.map